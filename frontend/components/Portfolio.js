  ...
  return (
    <main className="w-full max-w-4xl mx-auto px-4">
      <section className="min-h-screen flex flex-col items-center justify-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-8 text-center font-poppins bg-gradient-to-r from-purple-400 to-pink-600 text-transparent bg-clip-text">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a href="mailto:amadeus@example.com" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-pink-500 rounded-full shadow-md group">
